...
<body>
    ...
    <h5>添加需要的插件源，按照格式填入diy-part1.sh或者去yaml页面进入编辑82行<br />格式：echo 'src-git <文件夹名称>  <源地址>' >>feeds.conf.default</h5>
    <h5>修改固件默认ip地址，请修改diy-part2.sh或者去yaml页面进入编辑96行，10.10.10.2换成需要的IP地址</h5>
